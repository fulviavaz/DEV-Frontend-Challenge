  ...
  return (
    <div>
      {data?.order_entries.map((entry, id) => (
        <div key={entry.id}>
          <div className="flex items-start justify-between w-full pb-2 pt-2">
            ...
            <div className="flex flex-col items-start justify-center lg:w-4/5 lg:ml-2 ml-1">
              <div className="flex items-center justify-start mb-2">
                <p className="text-sm text-gray-800 font-medium mr-1">
                  {entry.product_name.trim().slice(0, 15)}
                </p>
